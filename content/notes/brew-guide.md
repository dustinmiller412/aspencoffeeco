...
tags: [Brew, Taste]
excerpt: "No lab equipment required. Just a few small changes that make a real difference in the cup."
coverImage: "https://cdn.shopify.com/s/files/1/0968/1915/1139/files/vlad-tchompalov-GkKASBpAisQ-unsplash.jpg?v=1768957758"
---
...
<div class="callout callout--feature">
  ...
  <p class="callout-display">Taste wins.</p>
  <p class="callout-sub">These are starting points, not commandments. If something tastes good to you, it's right. Use the guide as a framework, then adjust until the cup feels like yours.</p>
</div>

## The Workhorse: Drip Machine

<div class="callout callout--grid">
  <div class="callout-col">
    <p class="callout-label">Best for</p>
    <p class="callout-body">Getting coffee into your body with minimal friction</p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Ratio</p>
    <p class="callout-body">1:16</p>
    <p class="callout-body"><em>20g coffee to 320g water</em></p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Grind</p>
    <p class="callout-body">Medium</p>
    <p class="callout-body"><em>Like coarse sand</em></p>
  </div>
</div>
...
<div class="callout">
  ...
  <ul class="callout-list">
    <li><strong>Tastes weak?</strong> You're not using enough coffee. Add more.</li>
    <li><strong>Tastes bitter?</strong> Grind is too fine, or the coffee is too old.</li>
    <li><strong>Tastes sour or hollow?</strong> Grind is too coarse, or dose is too small.</li>
  </ul>
</div>
...
<div class="callout callout--grid">
  <div class="callout-col">
    <p class="callout-label">Best for</p>
    <p class="callout-body">Big body, cozy texture, the kind of morning where you're not in a hurry</p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Ratio</p>
    <p class="callout-body">1:15</p>
    <p class="callout-body"><em>40g coffee to 600g water</em></p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Grind</p>
    <p class="callout-body">Coarse</p>
    <p class="callout-body"><em>Like breadcrumbs</em></p>
  </div>
</div>
...
<div class="callout">
  <p class="callout-label">When things go wrong</p>
  <ul class="callout-list">
    <li><strong>Harsh or gritty?</strong> Grind coarser.</li>
    <li><strong>Tastes thin?</strong> Grind slightly finer, or add a touch more coffee.</li>
  </ul>
</div>
...
<div class="callout callout--grid">
  <div class="callout-col">
    <p class="callout-label">Best for</p>
    <p class="callout-body">Tasting what's actually in the coffee, slowing down, impressing yourself</p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Ratio</p>
    <p class="callout-body">1:15 to 1:17</p>
    <p class="callout-body"><em>20g coffee to 300–340g water</em></p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Grind</p>
    <p class="callout-body">Medium-fine</p>
    <p class="callout-body"><em>Closer to sugar than sand</em></p>
  </div>
</div>
...
<div class="callout">
  <p class="callout-label">When things go wrong</p>
  <ul class="callout-list">
    <li><strong>Sour or sharp?</strong> Grind finer, or pour more slowly.</li>
    <li><strong>Bitter or drying?</strong> Grind coarser.</li>
    <li><strong>Uneven or channeled?</strong> Focus on keeping your pour centered and consistent.</li>
  </ul>
</div>
...
<div class="callout callout--grid">
  <div class="callout-col">
    <p class="callout-label">Best for</p>
    <p class="callout-body">Intensity, milk drinks, the satisfaction of figuring something hard out</p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Starting ratio</p>
    <p class="callout-body">1:2</p>
    <p class="callout-body"><em>18g in to 36g out</em></p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Grind</p>
    <p class="callout-body">Fine</p>
    <p class="callout-body"><em>Espresso fine, but not choking the machine</em></p>
  </div>
</div>
...
<div class="callout">
  <p class="callout-label">When things go wrong</p>
  <ul class="callout-list">
    <li><strong>Sour, thin, or fast?</strong> Grind finer, or add more coffee.</li>
    <li><strong>Bitter, dry, or slow?</strong> Grind coarser, or reduce dose slightly.</li>
    <li><strong>Tastes fine but different every time?</strong> Focus on your dose and tamp before touching the grind.</li>
  </ul>
</div>
...
<div class="callout callout--grid">
  <div class="callout-col">
    <p class="callout-label">Best for</p>
    <p class="callout-body">Smooth coffee, low acidity, barely any effort</p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Ratio</p>
    <p class="callout-body">1:8</p>
    <p class="callout-body"><em>100g coffee to 800g water</em></p>
  </div>
  <div class="callout-col">
    <p class="callout-label">Grind</p>
    <p class="callout-body">Very coarse</p>
    <p class="callout-body"><em>Closer to cracked peppercorns</em></p>
  </div>
</div>
